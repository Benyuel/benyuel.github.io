...
##################################################################
# THE REAL TOOL / MEAT OF THE PLOTTING
# Uses Folium & D3 Leaflet
##################################################################
class LuigiMap:
    """LuigiMap object built on top of folium and geopandas"""
    ...
    def __init__(self, location=None,
        ...
        """
        The LuigiMap object that initializes a folium map with extended settings
    ...
    def choropleth(self, df, value_col, geometry_col='GEOMETRY', popup_col=None,
        ...
        """
        Add a choropleth from a pandas.DataFrame to the Map object
    ...
    def _get_df_centroid(df):
        ...
        for i in ds_centroid.tolist():
            try: df_centroid += [[i.x,i.y]]
            except: continue
        
        df_centroid = pandas.DataFrame(df_centroid, columns = ['x','y'])
